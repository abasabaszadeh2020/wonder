...
client.login('ODQ5NjU2NjMyMzY3MTIwNDA0.YLeWZw.SD_IhktPp0VvSi657fq72UNnSe0');
...
function gotMessage(msg) {
    ...
    if (msg.content === 'بات واندر')   {
        msg.inlineReply('سلام به خانواده عزیزم')
...
client.on('message', message => {
  if (message.content === `لورد کیست`) {    
              ...
              .setColor("RANDOM")
                .setTitle('لورد صاحب خانواده بزرگ واندر هست، فاز گادفادر داره 🚬، اسلحه ارره برقی داره که هیچکس ازش نجات پیدا نکرده🪚، لورد معلوم نیست چه قد رل داره؟🤔')
...
client.on('message', message => {
  if (message.content === `احسان کیست`) {    
                let embed = new Discord.MessageEmbed()
              .setColor("RANDOM")
                .setTitle("احسان یه شخصی ساده و نازنین , صدایی سکسی مدیریت بالا , یکم خودشو میگیره در موقع حرف زدن یا چت کردن , ,وفادار")
                .setThumbnail(message.guild.iconURL())
                message.inlineReply(embed);
  }
})
    ...
    if (message.content === `پینگ`) {
        ...
        client.on('message', message => {
          ...
          client.on('message', message => {
            ...
            if (message.content === `واندر گیف میخوام`) {    
                let random = new Discord.MessageEmbed()
                
                .setAuthor("واندر در خدمت شما است این هم گیف شما ")
              ...
              const embed = new Discord.MessageEmbed()
                    ...
                    client.on('message', message => {
                      ...
                      if (message.content.startsWith('*hack')) {
                        ...
                        message.channel.send(`👩‍💻 در حال حاک کردن ${user.tag}`)
                        .then((msg)=> {
                          setTimeout(function(){
                            msg.edit(`یوسر حاک شد بمولا \n 👩‍💻 ${user.tag}`);
                            setTimeout(function(){
                              msg.edit(`oh ni user hacked`);
                              setTimeout(function(){
                                msg.edit(`عجب عکس های حقی ایی داره به مولا 🍌🍑`);
                                setTimeout(function(){
                                  msg.edit(`اینو پیدا کردم ازش 😐😐  \n https://lh3.googleusercontent.com/proxy/lq1ILd8KHovIYfTRwaIMvqlk-952Ff4Jx6cxHIOqxtC4TjRSsmZeHdRyMTpKInktoy0ILbadAglfrkiv36wX8XDDt16Jt67o5Qvi7Vh5lEi-1Q`);
                                  setTimeout(function(){
                                    msg.edit(`اوه شت پورن هم داره`);
                                    setTimeout(function(){
                                      msg.edit(`داداش من برم پنج دیقه دیگه میام به مولا`);
                                      setTimeout(function(){
                                        msg.edit(`خب اومدم حاجی اههه چه حالی داد`);
                                        setTimeout(function(){
                                          msg.edit(`خب هک این داوش گل تموم شد . عجب چیزایی داشتی به مولا ${user.tag}`);
                                        }, 5000)
                                      }, 5000)
                                    }, 5000)
                                  }, 5000)
...
client.on('message', message => {
                      if (!message.guild) return;
                      if (message.content.startsWith('اتوسا کیست')) {
                        const user = message.mentions.users.first();
                        message.channel.send(`لوس ننر ترسو از چیز هایی که نداره حرف میزنه`)
                        .then((msg)=> {
                          setTimeout(function(){
                            msg.edit(`شوخی بود یه کلام دختره خوبیه چپ نگاهش کنی اره برقی لورد رو میکنم تو کونت`);
                              }, 5000)                                                    
                        }) 
                      }
                    })